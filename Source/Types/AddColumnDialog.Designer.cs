namespace TPCourse.Source.Types
{
	...
	{
		private TPCourse.Source.Table.Column.FormatConfigurationPanel FC_Pnl_DataTypeFormatConfiguration;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.FC_Pnl_DataTypeFormatConfiguration = new TPCourse.Source.Table.Column.FormatConfigurationPanel();
			this.SuspendLayout();
			// 
			// Btn_OK
			// 
			...
			// TBox_ColumnName
			// 
			this.TB_ColumnName.Location = new System.Drawing.Point(119, 17);
			this.TB_ColumnName.Name = "TBox_ColumnName";
			this.TB_ColumnName.Size = new System.Drawing.Size(180, 20);
			this.TB_ColumnName.TabIndex = 2;
			this.TB_ColumnName.Text = "Столбец";
			// 
			// Lbl_ColumnName
			// 
